...
# set input video
#cap = cv2.VideoCapture('D:/Stage/67 HA/DJI_0006.mp4')
...
while(cap.isOpened()):
    ...
    # cv2.putText(frame, MTR_up, (10, 30), font, 2, (255, 255, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, MTR_up, (10, 40), font,1, (0, 0, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, LV_up, (10, 60), font, 1, (255, 255, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, LV_up, (10, 60), font, 1, (0, 0, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, HV_up, (10, 80), font, 1, (255, 255, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, HV_up, (10, 80), font, 1, (0, 0, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    ...
    cv2.putText(frame, LV_down, (10, 120), font, 1, (255, 255, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, LV_down, (10, 120), font, 1, (255, 0, 0), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, HV_down, (10, 140), font, 1, (255, 255, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, HV_down, (10, 140), font, 1, (255, 0, 0), 1, cv2.FONT_HERSHEY_PLAIN)

    cv2.imshow('Frame', cv2.resize(frame, (600, 500)))
