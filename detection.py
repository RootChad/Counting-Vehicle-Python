...
if __name__ == '__main__':
    ...
    parser.add_argument('-w', '--weights', type=str, default='model/yolov3-tiny.weights', help='Path to model weights')
    parser.add_argument('-cfg', '--config', type=str, default='model/yolov3-tiny.cfg', help='Path to configuration file')
    ...
    input_group.add_argument('-v', '--video_path', type=str, default='D:/Stage/67 HA/DJI_0003.MP4', help='Path to the video file.')
    ...
    if args.image_path != '':
        ...
        if args.save:
            ...
            name = args.video_path.split("/")[-1] if args.video_path else 'cars.mp4'
